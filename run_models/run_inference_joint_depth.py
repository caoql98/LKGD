...
output_path = "/data/vjuicefs_ai_camera/11162591/public_datasets/share_files/cond_lora_alignt/checkpoint-9000"
...
if use_noise_lora:
    noise_lora_path = "/data/vjuicefs_ai_camera/11162591/public_datasets/share_files/noise_lora"
    pipeline.load_lora_weights(save_dir, adapter_name="noise_lora")
    active_adapters += ["noise_lora"]
