...
if __name__ == "__main__":
    args = {
        ...
        "validation_image": "/data/juicefs_sharing_data/72179586/repos/VidToMe/outputs/tea-pour/vector/frames/0024.png",
        "output_dir": "./output",
        "height": 320,
        "width": 576,
    ...
    start_f = 24
    n_frames = 14
    video_frames = pipeline(validation_image, validation_control_images[start_f:start_f+n_frames], decode_chunk_size=8,num_frames=n_frames,motion_bucket_id=10,controlnet_cond_scale=1.0,width=args["width"],height=args["height"]).frames
