...
def main():
    ...
    patch.set_patch_lora_mask(unet, "xy_lora", [1,1])
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(cur_train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                joint_latents = torch.cat([video_latents, video_latents.flip(dims = [1])], dim = 0)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if (
                        ...
                        patch.set_patch_lora_mask(raw_unet, "xy_lora", [1,1,1,1])
                        patch.set_joint_attention_mask(unet, [1,0,1,0])
                        # create pipeline
                        ...
                        with autocast_ctx:
                            ...
                            end_frame = T.ToPILImage()(validation_images[num_frames - 1])
                            videos = pipeline(
                        ...
                        patch.set_patch_lora_mask(raw_unet, "xy_lora", [1,1])
                        patch.set_joint_attention_mask(unet, [1,0])
