...
accelerate launch train_models/train_mask_depth_lora_joint.py \
 ...
 --train_data_dir="/home/bml/storage/mnt/v-95c5b44cfcff4e6c/org/data_lxr/data/PascalVOC/VOC2012/hed" \
 --image_column="image" \
 --caption_column="text" \
 --validation_prompt="a large modern house with a stone walkway and a stone patio" \
 --output_dir="output_dir/output_mask_hed_lora_joint_rank64_no_timestep_align_add_norm" \
 --random_flip \
 --train_batch_size 16 \
 --num_train_epochs 40 \
...
#  --resume_from_checkpoint "/home/bml/storage/mnt/v-95c5b44cfcff4e6c/org/data_lxr/svd-train/output_dir/output_mask_hed_lora_joint_rank64_conv_fuse/halfstone-10000"
