...
accelerate launch train_models/train_mask_depth_lora_joint.py \
 ...
 --train_data_dir="/home/bml/storage/mnt/v-95c5b44cfcff4e6c/org/data_lxr/data/PascalVOC/VOC2012/oneformer-coco-seg" \
 --image_column="image" \
 --caption_column="text" \
 --validation_prompt="a large modern house with a stone walkway and a stone patio" \
 --output_dir="output_dir/output_mask_seg_lora_joint_rank64" \
 --random_flip \
 --train_batch_size 16 \
 --num_train_epochs 40 \
 ...
 --cond_depth_path "/home/bml/storage/mnt/v-95c5b44cfcff4e6c/org/data_lxr/svd-train/inputs/House_seg.webp" \
 --checkpointing_steps 1000 \
 --mask_dropout_prob 0.1 \
 --prompt_dropout_prob 0.1 \
 --seed 142847 \
 --trigger_word "seg_map, " \
 --rand_transform \
 --report_to wandb \
 --train_y \
 --resume_from_checkpoint "/home/bml/storage/mnt/v-95c5b44cfcff4e6c/org/data_lxr/svd-train/output_dir/output_mask_seg_lora_joint_rank64/halfstone-10000"
