...
accelerate launch train_models/train_multi_cond_lora_joint.py \
 --pretrained_model_name_or_path="runwayml/stable-diffusion-v1-5" \
 --train_data_dir="/home/bml/storage/mnt/v-95c5b44cfcff4e6c/org/data_lxr/data/PascalVOC/dataset_files/train_dataset.json" \
 --dataset_type="json" \
 --caption_column="text" \
 --validation_prompt="a man riding a horse in a field" \
 --output_dir="output_final/output_depth_normal_lora_joint_rank64_nta_convfuse" \
 --random_flip \
 --train_batch_size 16 \
 --num_train_epochs 40 \
 ...
 --no_timestep_align \
 --image_column2="normal_image" \
 --image_column="depth_gray_image" \
 --trigger_word "depth_map, " \
 --trigger_word2 "normal_map, " \
#  --report_to wandb \
