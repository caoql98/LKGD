...
accelerate launch train_models/train_mask_depth_lora_joint.py \
 ...
 --train_data_dir="/home/bml/storage/mnt/v-95c5b44cfcff4e6c/org/data_lxr/data/PascalVOC/VOC2012/normal/" \
 --image_column="image" \
 --caption_column="text" \
 --validation_prompt="a man riding a horse in a field" \
 --output_dir="output_dir/output_mask_normal_lora_joint_rank64_skipencoder" \
 --train_batch_size 16 \
 --num_train_epochs 40 \
...
#   --random_flip  We cannot use random flip when generalizing normal map
