...
OUTPUT_ARGS=(
    --output_dir "output/depthCharge-e60"  # output directory
    --report_to "tensorboard"
)

# Data Configuration
DATA_ARGS=(
    --data_root "data/fluid_videos/depthCharge_vision/train_videos_c"
...
TRAIN_ARGS=(
    --train_epochs 60 # number of training epochs
    --seed 42 # random seed
    --batch_size 1
...
VALIDATION_ARGS=(
    ...
    --validation_dir "data/fluid_videos/depthCharge_vision/test_imgs"
