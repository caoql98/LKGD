...
OUTPUT_ARGS=(
    --output_dir "output/damBreak-e60"  # output directory
    --report_to "tensorboard"
)

# Data Configuration
DATA_ARGS=(
    --data_root "data/fluid_videos/damBreak_vision/train_videos_c"
...
VALIDATION_ARGS=(
    ...
    --validation_dir "data/fluid_videos/damBreak_vision/test_imgs"
