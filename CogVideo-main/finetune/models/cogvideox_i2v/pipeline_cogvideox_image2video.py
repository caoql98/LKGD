...
class CogVideoXImageToVideoPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    ...
    def __init__(
        ...
        domain_model: Optional[torch.nn.Module] = None,
    ...
    def __call__(
        ...
        domain_features = self.domain_model(domain_images).unsqueeze(1)
        flow_features = self.flow_model(domain_images).unsqueeze(1)
