...
OUTPUT_ARGS=(
    --output_dir "output/typhoon_202001"  # output directory
    --report_to "tensorboard"
)

# Data Configuration
DATA_ARGS=(
    --data_root "data/typhoon_videos/typhoon_202001/train_videos_c"
...
VALIDATION_ARGS=(
    ...
    --validation_dir "data/typhoon_videos/typhoon_202001/test_imgs"
