...
OUTPUT_ARGS=(
    --output_dir "output/typhoon_202102"  # output directory
    --report_to "tensorboard"
)

# Data Configuration
DATA_ARGS=(
    --data_root "data/typhoon_videos/typhoon_202102/train_videos_c"
...
TRAIN_ARGS=(
    --train_epochs 70 # number of training epochs
    --seed 42 # random seed
    --batch_size 1
...
VALIDATION_ARGS=(
    ...
    --validation_dir "data/typhoon_videos/typhoon_202102/test_imgs"
